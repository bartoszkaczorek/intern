define([
	...
	'./util'
], function (require, lang, Promise, http, path, fs, mimetype, url, aspect, winstonFactory, util) {
	/* jshint node:true */

	function getLoggerOptions(config) {
		var result = {};
		if (config !== null && config !== undefined
				&& config.internServerOptions !== null
				&& config.internServerOptions !== undefined
				&& config.internServerOptions.logger != null
				&& config.internServerOptions.logger !== undefined) {
